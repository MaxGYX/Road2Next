...
* **Agent**
  - 智能体，通常指以大语言模型LLM作为驱动的，具有理解感知、规划、记忆和使用工具的能力，能自动化执行完成某些复杂任务的系统。
  - 其实核心就是LLM用来理解任务和执行或者输出结果，并在LLM之上具有记忆数据能力，调用其他工具的能力以及进行任务规划能力（大概率就是一些prompt）的一个系统。

    <img width="753" height="330" alt="image" src="https://github.com/user-attachments/assets/f7d6214e-2cdc-4648-bcc1-0f0619710278" />
